...
import { Bell, CreditCard, AlertCircle, CheckCircle, Clock } from 'lucide-react';
    ...
    <div className="space-y-6 pb-6" dir="rtl">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">تنبيهات المدفوعات والعقود</p>
        </div>
            ...
            >
              ...
              <div className="flex-1 pr-2">
                <div className="flex justify-between items-start mb-1">
                  <h4 className={`font-semibold ${!notification.read ? 'text-gray-900 dark:text-gray-100' : 'text-gray-700 dark:text-gray-300'}`}>
                    {notification.title}
                  </h4>
                ...
                <div className="flex gap-2">
                  {notification.relatedId && (
                     <button 
                       onClick={() => handleAction(notification.id, notification.relatedId)}
