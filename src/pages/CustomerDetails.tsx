    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <Card className="border-0 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/40 dark:to-blue-800/40">
          <div className="text-blue-600 dark:text-blue-300 text-xs font-bold uppercase tracking-wider mb-1 flex items-center gap-1">
            <Phone className="w-4 h-4" /> الهاتف
          </div>
          <div className="font-bold text-blue-900 dark:text-blue-100 text-sm mt-2">
            {customer.phone}
          </div>
        </Card>
        <Card className="border-0 bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-900/40 dark:to-emerald-800/40">
          <div className="text-emerald-600 dark:text-emerald-300 text-xs font-bold uppercase tracking-wider mb-1 flex items-center gap-1">
            <MapPin className="w-4 h-4" /> العنوان
          </div>
          <div className="font-bold text-emerald-900 dark:text-emerald-100 text-sm mt-2 truncate">
            {customer.address || "-"}
          </div>
        </Card>
      </div>
          ...
          <div className="space-y-3">
            ...
            {customerPayments.map((payment) => {
              ...
              return (
                <Card
                  key={payment.id}
                  className="relative !p-4 border-0 bg-white dark:bg-gray-800"
                >
                  <div className="flex justify-between items-center bg-gray-50 dark:bg-gray-800/50 p-3 rounded-xl border border-gray-100 dark:border-gray-700">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-gray-500 dark:text-gray-400 mt-1 truncate max-w-[150px] sm:max-w-xs">
